...
public class CherryEnemy : Enemy {
    public Sprite idle;
    ...
    private IEnumerator Attacking()
    {
        ...
        enemySpeed = 0;
        attacking = true;
        enemyTrigger.gameObject.GetComponent<SpriteRenderer>().color = new Color(0.6f, 0.6f, 0.6f);
        yield return new WaitForSeconds(0.2f);
        enemyTrigger.gameObject.GetComponent<SpriteRenderer>().color = new Color(0.3f, 0.3f, 0.3f);
        yield return new WaitForSeconds(0.2f);
        enemyTrigger.gameObject.GetComponent<SpriteRenderer>().color = new Color(0.1f, 0.1f, 0.1f);
        yield return new WaitForSeconds(0.4f);
        enemyTrigger.enemyAttackEffect.SetActive(true);
        enemyTrigger.gameObject.GetComponent<SpriteRenderer>().color = new Color(1, 1, 1);
        enemyTrigger.gameObject.GetComponent<SpriteRenderer>().sprite = attack;
        yield return new WaitForSeconds(0.5f);
       
        GameController.gameController.BattleCheck();
